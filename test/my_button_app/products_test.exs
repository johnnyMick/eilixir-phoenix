defmodule MyButtonApp.ProductsTest do
  use MyButtonApp.DataCase

  alias MyButtonApp.Products

  describe "products" do
    alias MyButtonApp.Products.Product

    import MyButtonApp.ProductsFixtures
